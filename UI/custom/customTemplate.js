                    ...
                    {{if  msgData.message && msgData.message[0].component.payload.mobileNumber}}\
                        <div class="phone-number-block">\
                            <div class="icon-block">\
                                <img src="{{if msgData.message && msgData.message[0].component.payload.mobileIcon}}${msgData.message[0].payload.component.mobileIcon}{{else}}data:image/png;base64,{{/if}}">\
                            </div>\
